...
public class ListaDeAlojamientos {
    ...
    private void crearUbicaciones(){
        ...
        ubicaciones.add(new Ubicacion(1,-42.6,-38.3,"San Martin","1989", ciudades.get(0),1));
        ubicaciones.add(new Ubicacion(2,-41.2,-37.5,"Francia","1561", ciudades.get(0),1));
        ubicaciones.add(new Ubicacion(3,-42.25,-38.2,"Lopez y Planes","2007", ciudades.get(1),2));
        ubicaciones.add(new Ubicacion(4,-42.31,-38.7,"Urquiza","4231", ciudades.get(1),2));
    }
    private void crearAlojamientos(){

        hoteles = new ArrayList<>();
        hoteles.add(new Hotel(1, "Hotel Puerto Amarras", 5, ubicaciones.get(3),4));
        ...
        departamentos = List.of(
                ...
                new Departamento(UUID.fromString("13048bcc-d1ab-4dc5-a106-935bf1a0099d"), "Gran vista de la ciudad", "Departamento con una hermosa vista a la ciudad",
                        2, 3050.0, true, 1000.0, 1,ubicaciones.get(2),3)
        );
