...
public interface FavoritoDao {
    ...
    @GET("favorito")
    Call<List<FavoritoEntity>> getAll();

    @GET("favorito")
    Call<List<FavoritoEntity>> getFromUser(@Query("usuarioId") UUID idUsuario);

    @POST("favorito")
    Call<FavoritoEntity> insertar(@Body FavoritoEntity favoritoEntity);
