...
public class AlojamientoRepository {
    ...
    public static final List<Alojamiento> _ALOJAMIENTOS = List.of(
            ...
            new Habitacion(2, "Habitacion 2", "Espectacular suite",4, 1200.0, 2,1,true,new Hotel(1,"Hotel 1",3,ubicacion2),
                    "https://media-cdn.tripadvisor.com/media/photo-s/16/1a/ea/54/hotel-presidente-4s.jpg"),
            new Habitacion(2, "Habitacion 3", "This modern and elegantly-furnished hotel is located in the centre of Letojanni, a small and picturesque village in Taormina bay, just 80 m from the Ionian Sea.\n" +
